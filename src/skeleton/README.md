# skeleton package README

This directoy contains the build files for the skeleton package, which is part
of the skeleton roll. Unique to the skeleton roll/package is the bundled 
